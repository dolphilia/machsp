...
static int lastcr; // CR/LFで終了している
static char *base = NULL;
static char *nn; // 先頭ポインタ
static char *lastnn;
static char lastcode;
static char nulltmp[4] = {0};
...
/// @return 0 = ok / 1 = no line
///
int GetLine2(char *str, int line, int max) {
    char cur_char; //現在の文字
    char *ptr = str;
    if (nnget(base, line))
        return 1;
...
/// @return 0 = ok / 1 = no line
///
int PutLine(char *nstr2, int line, int ovr) {
    int a = 0, ln, la, lw;
    char cur_char;
    char *ptr;
    char *p1;
