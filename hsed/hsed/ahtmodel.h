...
public:
    ...
    void SetObj(AHTOBJ *val) {
        obj = *val;
    };

    void ClearFindCheck(void) {
        findcheck = false;
    };

    void SetFindCheck(void) {
        findcheck = true;
    };

    bool GetFindCheck(void) {
        return findcheck;
    };
