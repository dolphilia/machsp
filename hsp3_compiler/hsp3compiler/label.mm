...
-(int)Regist2:(char*)name type:(int)type opt:(int)opt filename:(char const*)filename line:(int)line {
    ...
    //[labels setObject:[NSString stringWithCString:lab->name encoding:NSUTF8StringEncoding] forKey:[NSString stringWithFormat:@"%d", label_id]];
